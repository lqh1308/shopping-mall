...
<head>
    ...
    <style id="XIANKEFU-STYLE">
        .XIANKEFU-bar{position: fixed; bottom: 50px; right: 50px; font-size: 16px; cursor: pointer; text-overflow: ellipsis; overflow: hidden;  background-color: #56b7c7; background-image: linear-gradient(to right,#56b7c7,#67D0AF); color: #fff;}
...
<script async="" charset="utf-8" src="view/default/js/xiankefu.js"></script><script>
    ...
    <div id="XIANKEFU-PANEL" class="XIANKEFU-panel">
        <iframe allowtransparency="true" frameborder="0" scrolling="no" name="XIANKEFU_SELF" src="view/default/images/index/saved_resource.html"></iframe>
    </div>
</@layout.b>
</body>
</html>