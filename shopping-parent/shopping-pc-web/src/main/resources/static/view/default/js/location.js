...
function chooseCity(cityId,cityName){
	...
	$.ajax({
		type: "GET",
		url: "https://demo.yunec.cn/index.html?p=cart&rd=" + Math.random(),
		data: {
			act: 'get_area',
			pid: cityId
		},
		dataType: "jsonp",
		jsonp: "jsonpProcess",
		jsonpCallback: "success_callBack", // jsonpProcess自定义函数名
    ...
    */
    ...
    /*
	$.getJSON("https://demo.yunec.cn/index.html?p=cart&rd=" + Math.random(), {act: 'get_area',pid: cityId}, function (r) {
		getAreaListcallback(r);
		$("#stock_area_item a").click(function () {
			chooseArea($(this).data("value"),$(this).html());
			$('#store-selector').addClass('hover');
